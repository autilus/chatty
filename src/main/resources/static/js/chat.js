...
$(document).ready(function () {
    ...
    function sendPrivate(){
        ...
        $('#messageInput').val('');
        addMessage({ text: data, to: username, from: myUsername, date: moment().format("HH:mm:ss") });
    }
    ...
    function receivedPrivateMessage(message) {
        ...
        addMessage({to: to, from: to, text: text, date: moment(message['date']).format("HH:mm:ss")});
    }
    ...
    function receivedPublicMessage(message) {
        ...
        var from = message['from'];
        var text = message['message'];
        addMessage({to: to, from: from, text: text, date: moment(message['date']).format("HH:mm:ss")});
    }
    ...
    function sendPublic(){
        ...
        if(data !== undefined && data !== '') {
            ...
            $('#messageInput').val('');
            addMessage({ to: "Public", text: data, from: myUsername, date: moment().format("HH:mm:ss") });
        } else {
